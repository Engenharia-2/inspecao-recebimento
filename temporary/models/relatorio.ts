...
class Relatorio extends Model<RelatorioAttributes, RelatorioAttributes> implements RelatorioAttributes {
  ...
  declare entryImages?: object;
  declare assistanceImages?: object;
  declare qualityImages?: object;
...
Relatorio.init({
  ...
  entryImages: { type: DataTypes.JSON },
  assistanceImages: { type: DataTypes.JSON },
  qualityImages: { type: DataTypes.JSON },
